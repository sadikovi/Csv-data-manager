        ...
        if (userID != null && userID.length() > 0) {
            try {
                ...
                if (biServerURL == null || biServerURL.length() <= 0) {
                    ...
                    sAWSessionService = new SAWSessionService(ServiceParams.getWSDLLocationURL(biServerURL),ServiceParams.getQName("SAWSessionService"));
                }
                ...
                System.err.println("Unauthorised user tried to access csv import utility.");
                e.printStackTrace();
            }
        }
